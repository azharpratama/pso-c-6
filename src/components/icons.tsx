...
export function ShieldIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      <path d="M12 3l7 3v5c0 5-3.5 9-7 10-3.5-1-7-5-7-10V6l7-3z" strokeWidth="1.6" />
...
export function EyeIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      <path d="M2.5 12s3.5-6 9.5-6 9.5 6 9.5 6-3.5 6-9.5 6-9.5-6-9.5-6z" strokeWidth="1.6" />
...
export function EyeOffIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      ...
      <path d="M5.5 7.5C3.6 9.1 2.5 12 2.5 12s3.5 6 9.5 6c2.2 0 4.1-.7 5.6-1.7" strokeWidth="1.6" />
      <path d="M9.4 6.2A9.6 9.6 0 0 1 12 6c6 0 9.5 6 9.5 6s-1.5 2.6-4.2 4.5" strokeWidth="1.6" />
...
export function BellIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      <path d="M6 16h12l-1.5-2.4V10a4.5 4.5 0 1 0-9 0v3.6L6 16z" strokeWidth="1.6" />
...
export function UsersIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      ...
      <path d="M13 17.5c.8-1.4 2.2-2.2 3.5-2.2 1.2 0 2.5.7 3.2 2.2" strokeWidth="1.6" />
    </svg>
  );
}
...
export function ChartIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      ...
      <path d="M7 14l4-4 3 3 5-6" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function SettingsIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      ...
      <path d="M4.5 12l1.6-.4.7-1.7-1-1.4 1.5-1.5 1.4 1 1.7-.7.4-1.6h2.2l.4 1.6 1.7.7 1.4-1 1.5 1.5-1 1.4.7 1.7 1.6.4v2.2l-1.6.4-.7 1.7 1 1.4-1.5 1.5-1.4-1-1.7.7-.4 1.6H10l-.4-1.6-1.7-.7-1.4 1-1.5-1.5 1-1.4-.7-1.7-1.6-.4V12z" strokeWidth="1.2" />
    </svg>
  );
}
...
export function DownloadIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      ...
      <path d="M8 10l4 4 4-4" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
